...
public class GenTieUCPDPUMR extends MRJob {
	...
	public boolean init(String date) {
		...
		outputList.add(DirConstant.WEBLOG_STATISTICS_TEMP_DIR + "GenTieUCPDPUMRTemp2/" + date);
		outputList.add(DirConstant.WEBLOG_STATISTICS_TEMP_DIR + "GenTieUCPDPUMR2/" + date);
		return true;
	}
