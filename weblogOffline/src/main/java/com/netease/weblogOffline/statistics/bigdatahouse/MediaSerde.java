...
public class MediaSerde implements Deserializer {
	...
	static {
		for(String column : MediaUtils.getColumns()){
	...
	public Object deserialize(Writable writable) throws SerDeException {
		...
		try {
			...
			if(rowMap != null){
				...
				for (String column : MediaUtils.getColumns()){
					result.add(rowMap.getHm().get(column)==null?MediaUtils.defNullStr:rowMap.getHm().get(column));
				}
			}
