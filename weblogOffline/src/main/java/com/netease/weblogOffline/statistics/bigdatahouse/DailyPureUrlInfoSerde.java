...
public class DailyPureUrlInfoSerde implements Deserializer {
	...
	static {
		for(String column : DailyUrlInfoUtils.getPureurlcolumns()){
	...
	public Object deserialize(Writable writable) throws SerDeException {
		...
		try {
			...
			if(rowMap != null){
				...
				for (String column : DailyUrlInfoUtils.getPureurlcolumns()){
					result.add(rowMap.getHm().get(column)==null?DailyUrlInfoUtils.defNullStr:rowMap.getHm().get(column));
				}
