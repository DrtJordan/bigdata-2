...
public class ChannelExitUrlCountAndUrlPv extends MRJob {

	private static final org.slf4j.Logger log = LoggerFactory
			.getLogger(ChannelExitUrlCountAndUrlPv.class);
	...
	public boolean init(String date) {
		...
		outputList.add(DirConstant.WEBLOG_STATISTICS_TEMP_DIR
				+ "ChannelBroadExitUrlInfo/" + date);

		outputList.add(DirConstant.WEBLOG_STATISTICS_TEMP_DIR
				+ "ChannelBroadExitUrlCountAndPv/" + date);
	...
	public int run(String[] args) throws Exception {
		...
		MultipleInputs.addInputPath(job1, new Path(inputList.get(0)),
				SequenceFileInputFormat.class, ChannelExitUrlPvMapper.class);

		MultipleInputs.addInputPath(job1, new Path(inputList.get(1)),
				SequenceFileInputFormat.class, ChannelExitUrlInfoMapper.class);
		...
		// reducer
		job1.setReducerClass(ChannelExitUrlInfoReducer.class);
		...
		MultipleInputs.addInputPath(job2, new Path(outputList.get(0)),
				...
				ChannelExitUrlCountPvMapper.class);
		...
		// reducer
		job2.setReducerClass(ChannelExitUrlCountPvReducer.class);
	...
	public static class ChannelExitUrlPvMapper
			extends
	...
	public static class ChannelExitUrlInfoMapper
	extends
	Mapper<ThreeStringWritable, IntWritable, ThreeStringWritable, IntWritable> {
	...
	public static class ChannelExitUrlInfoReducer extends
	...
	public static class ChannelExitUrlCountPvMapper extends
	...
	public static class ChannelExitUrlCountPvReducer extends
