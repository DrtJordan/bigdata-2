 ...
 * 从zy中计算每个url的pv、uv
 * */
public class ContentPvUvMR extends MRJob {
	@Override
	public boolean init(String date) {
		inputList.add(DirConstant.ZY_LOG + date);
		outputList.add(DirConstant.WEBLOG_STATISTICS_TEMP_DIR + "contentPvUvTemp/" + date);
		outputList.add(DirConstant.WEBLOG_STATISTICS_TEMP_DIR + "contentPvUv/" + date);
		return true;
	}
    ...
    public static class LogMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        	...
        	try {
				...
				if(!NeteaseContentType.OTHER.equals(type)){
